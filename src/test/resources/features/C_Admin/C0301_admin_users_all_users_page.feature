...
Feature: Validate admin all user page functionality
  ...
  Scenario: Validate that elements are present with admin all users page
    ...
    Then Verify that search userfield placeholder value should be "Search by name, email or mobile..." from admin all users page
    ...
    Then Verify that pagination count size should be 10 from the admin all users page
