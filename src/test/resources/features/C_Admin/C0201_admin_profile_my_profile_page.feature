...
Feature: Validate Admin my profile page functionality
  ...
  Scenario: Validate that elements are present with admin profie pop up my profile page
    ...
    Then Verify that first name user field place holder value should be "Enter your first name" from the admin profie pop up my profile page
    ...
    Then Verify that last name user field place holder value should be "Enter your last name" from the admin profie pop up my profile page
    ...
    Then Verify that user name user field place holder value should be "Enter your username" from the admin profie pop up my profile page
    ...
    Then Verify that email user field place holder value should be "Enter your email address" from the admin profie pop up my profile page
    ...
    Then Verify that mobile number country code user field place holder value should be "" from the admin profie pop up my profile page
    Then Verify that mobile number user field should be clickable from the admin profie pop up my profile page
    Then Verify that mobile number user field placeholder value should be "Enter your mobile number" from the admin profie pop up my profile page
    ...
    Then Verify that profile image user field place holder value should be "Enter your user image URL" from the admin profie pop up my profile page
