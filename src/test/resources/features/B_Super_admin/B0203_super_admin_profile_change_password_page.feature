...
Feature: Validate super_admin change password page functionality
  ...
  Scenario: Validate that elements are present in the from super admin profile pop up change password page
    ...
    Then Verify that page breadcrum list should be displayed from the super admin profile pop up change password page
    Then Verify that page breadcrum dashborad button should be clickable from the super admin profile pop up change password page
    Then Verify that page breadcrum change password text is displayed from the super admin profile pop up change password page
    Then Verify that page current password title text above userfield should be displayed from the super admin profile pop up change password page
    Then Verify that page current password user field should be clickable from the super admin profile pop up change password page
    Then Verify that page current password user field placeholder value should be "Enter your current password" from the super admin profile pop up change password page
    Then Verify that page submit button should be displayed from the super admin profile pop up change password page
    Then Verify that page submit button should be clickable from the super admin profile pop up change password page
    Then Verify that page cancel button should be displayed from the super admin profile pop up change password page
    Then Verify that page cancel button should be clickable from the super admin profile pop up change password page
    Then Verify that page submit button should be able to mouse hover from super admin profile pop up change password page
    Then Verify that page cancel button should be able to mouse hover from super admin profile pop up change password page
  ...
  Scenario: Validate that elements are present in second change password from super admin user profile page
    ...
    Then Verify that page new password userfield should be clickable in the super admin profile pop up change password second page
    Then Verify that page new password userfield placeholder value should be "Enter your new password" in the super admin profile pop up change password second page
    Then Verify that page comfirm password title text is displayed in the super admin profile pop up change password second page
    Then Verify that page comfirm password userfield should be clickable in the super admin profile pop up change password second page
    Then Verify that page comfirm password userfield placeholder value should be "Confirm your password" in the super admin profile pop up change password second page
    Then Verify that page submit button should be displayed from the super admin profile pop up change password second page
    Then Verify that page submit button should be clickable from the super admin profile pop up change password second page
    Then Verify that page cancel button should be displayed from the super admin profile pop up change password second page
    Then Verify that page cancel button should be clickable from the super admin profile pop up change password second page
    Then Verify that page submit button should be able to mouse hover from super admin profile pop up change password second page
    Then Verify that page cancel button should be able to mouse hover from super admin profile pop up change password second page
