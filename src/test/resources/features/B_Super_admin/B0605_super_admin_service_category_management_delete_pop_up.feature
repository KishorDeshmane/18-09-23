@Super_admin_service_category_management_delete_pop_up
Feature: Validate super admin service category management delete pop up functionality
 
 @Smoke
  Scenario:  Validate that elemets is present with super admin service category management delete pop up
  Given Verify that super admin user is on lookups service category management delete pop up as expected page title is "Shield"
