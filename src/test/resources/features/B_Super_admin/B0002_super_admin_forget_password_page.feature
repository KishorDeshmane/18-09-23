...
Feature: Validate super admin forget password page functionality
  ...
  Scenario: Validate that request reset link button functionality in super admin forget password log in page
    Given Verify that user is on the super admin log in forget password page as expected page title is "Shield - Forgot Password"
    When super admin user enter only valid email and try to click on request set link in into app "ashish.upadhyay@iffort.com" from admin forget password log in page
    Then Verify that super admin user should get the expected note link has been sent to your email address from admin forget password log in page
...
#Same with all users is pending
  ...
  Scenario: Validate that email user field in super admin forget password page
    Given Verify that user is on the super admin log in forget password page as expected page title is "Shield - Forgot Password"
    When super admin user enter valid email and try to click on request reset link in into application "kd@iffort.co.uk" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter valid email and try to click on request reset link in into application "info@iffort.ifff.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter valid email and try to click on request reset link in into application "ashish-upadhyay@iffort.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter valid email and try to click on request reset link in into application "ashish+upadhyay@iffort.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg@" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg.co.in" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg@co.123" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg@co" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg@@@co" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "@example.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcsdf@.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcsd f@co.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "Kabc.f@co.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "  abcdefg@co.in  " in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "abcdefg@co.in         " in admin forget password log in page
    ...
    When super admin user enter invalid email and try to click on request reset link in into aplication "          abcdefg@co.in" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "!#$%$#e@example.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "!#$%$#e@&^%$.com" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
    When super admin user enter invalid email and try to click on request reset link in into aplication "!#$%$#e@^%$#.&%^" in admin forget password log in page
    Then Verify that super admin user should get the expected red tick in email user field in admin forget password log in page
