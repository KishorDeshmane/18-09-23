...
Feature: Validate Super admin dashboard page functionality
  ...
  @Smoke
  Scenario: Validate that elements are present with super admin dashboard page
  ...
  Scenario: Validate that elements from notification dropdown Super admin dashboard page
    ...
    Then Verify that user should get the text you have dot unread notifications from the super admin dashboard page
    Then Verify that user should get the list of the notifications from the super admin dashboard page
  ...
  Scenario: Validate that elements from profile dropdown Super admin dashboard page
    ...
    Then Verify that user name should be displayed in the profile dropdown from the super admin page
    Then Verify that user role should be displayed in the profile dropdown from the super admin page
    Then Verify that user last log in should be displayed in the profile dropdown from the super admin page
    Then Verify that user my profile dropdown item should be displayed in the profile dropdown from the super admin page
    Then Verify that user my profile dropdown item should be clickable in the profile dropdown from the super admin page
    Then Verify that user change password dropdown item should be displayed in the profile dropdown from the super admin page
    Then Verify that user change password dropdown item should be clickable in the profile dropdown from the super admin page
  ...
  Scenario: Validate that working of an tabs elements from Super admin dashboard page
    ...
    Then Verify that user is mouse hover on the lookups service areas button from the super admin home page
  ...
  Scenario: Validate that working of an footer elements in Super admin dashboard page
    ...
    When user is at the footer and click on the iffort link from the super admin dashboard page "https://www.iffort.com/"
    Then Verify that user should navigate to the new tab as expected page title is "Shield - Dashboard" from super admin dashboard page
