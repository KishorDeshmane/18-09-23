...
Feature: Validate executive my change password page functionality
  ...
  Scenario: Validate that elements are present in the executive my profile change password page
    ...
    Then Verify that page current password user field placeholder value should be "Enter your current password" from the executive my profile change password page
  ...
  Scenario: Validate that elements are present in the executive my profile change password second page
    ...
    Then Verify that page new password userfield placeholder value should be "Enter your new password" in the executive my profile change password second page
    ...
    Then Verify that page comfirm password userfield placeholder value should be "Confirm your password" in the executive my profile change password second page
