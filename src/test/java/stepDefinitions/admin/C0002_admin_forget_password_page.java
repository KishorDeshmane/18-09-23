...
public class C0002_admin_forget_password_page {
	...
	private Logger logger = LogManager.getLogger(C0002_admin_forget_password_page.class);
	...
	@Given("Verify that admin into the forget password page as expected title {string}")
	public void verify_that_user_is_on_the_log_in_as_admin_into_the_forget_password_page(String title) {
	...
	public void verify_that_forget_password_title_text_should_be_displayed_into_the_admin_forget_password_page() {
	...
	public void verify_that_forget_password_subtitle_text_should_be_displayed_into_the_admin_forget_password_page() {
	...
	public void verify_that_email_title_text_should_be_displayed_into_the_admin_forget_password_page() {
	...
	@Then("Verify that email user field should be placeholder value as expected {string} into the admin forget password page")
	public void verify_that_email_user_field_should_be_placeholder_value_as_expected_into_the_admin_forget_password_page(
			String expected) {
	...
	public void verify_that_email_user_field_should_be_clickable_into_the_admin_forget_password_page() {
	...
	public void verify_that_request_reset_link_should_be_clickable_into_the_admin_forget_password_page() {
	...
	public void verify_that_request_reset_link_button_be_able_to_mouse_hover_into_the_admin_forget_password_page() {
	...
	public void verify_that_did_you_remember_your_password_text_should_be_displayed_below_the_request_link_into_the_admin_forget_password_page() {
	...
	public void verify_that_try_to_sign_in_link_should_be_clickable_into_the_admin_forget_password_page() {
...
//	@Then("Verify that shield title text should be displayed into the admin forget password page")
//	public void verify_that_shield_title_text_should_be_displayed_into_the_admin_forget_password_page() {
...
//	}
	...
	public void verify_that_shield_logo_should_be_displayed_into_the_admin_forget_password_page() {
	...
	public void verify_that_shield_subtitle_reset_your_password_text_should_be_displayed_into_hte_admin_forget_password_page() {
	...
	public void verify_that_shield_subtitle_header_section_text_should_be_displayed_into_the_admin_forget_password_page() {
	...
	@When("admin user enter only valid email and try to click on request set link in into app {string} from admin forget password log in page")
	public void admin_user_enter_only_valid_email_and_try_to_click_on_request_set_link_in_into_app(String email) {
	...
	public void Verify_that_admin_user_should_get_the_expected_note_link_has_been_sent_to_your_email_address(){
	...
	@Then("Verify that user should get the mail with subject title is {string} from admin forget password log in page")
	public void verify_that_user_should_get_the_mail_with_subject_title_isoo(String string) {
	...
	@Then("Verify that mail containing link text must be {string} from admin forget password log in page")
	public void verify_that_mail_containing_link_text_must_bei(String string) {
	...
	@Then("Verify that reset password email link should navigates to the change password page {string} from admin forget password log in page")
	...
	@Given("Verify that user is on the admin log in forget password page as expected page title is {string}")
	public void verify_that_user_is_on_the_admin_log_in_forget_password_page_as_expected_page_title_is(String string) {
		DriverFactory.getDriver().get(AppHooks.prop.getProperty("url"));
		lp.user_log_in_to_super_admin_page();
		salogin.administrator_log_in_page_forget_password_link_is_clicked();
	...
	@When("admin user enter valid email and try to click on request reset link in into application {string} in admin forget password log in page")
	public void admin_user_enter_valid_email_and_try_to_click_on_request_reset_link_in_into_application(String email) {
	...
	public void verify_that_admin_user_should_get_the_expected_red_tick_in_email_user_field_in_admin_log_in_page() {
	...
	@When("admin user enter invalid email and try to click on request reset link in into aplication {string} in admin forget password log in page")
	public void admin_user_enter_invalid_email_and_try_to_click_on_request_reset_link_in_into_aplication(String email) {
		ElementUtil.eu.refresh_your_page(DriverFactory.getDriver());
		safp.user_forget_password_enter_email_into_user_field(email);
		String value=safp.user_forget_password_entered_email_text();
	...
	public void admin_user_enter_190_characters_into_the_email_user_field_and_try_to_click_on_request_reset_link_in_into_application() {
		ElementUtil.eu.refresh_your_page(DriverFactory.getDriver());
	...
	public void admin_user_enter_100_characters_into_the_email_user_field_and_try_to_click_on_request_reset_link_in_into_the_application() {
		ElementUtil.eu.refresh_your_page(DriverFactory.getDriver());
	...
	public void admin_user_enter_50_characters_into_the_email_user_field_and_try_to_click_on_request_reset_link_in_into_the_application() {
		ElementUtil.eu.refresh_your_page(DriverFactory.getDriver());
...
//	}
//
//	@Then("Verify that user is on the admin log in page and check email user field is empty")
//	public void  verify_that_user_is_on_the_admin_log_in_page_and_check_email_user_field_is_empty() {
...
//	public void  verify_that_user_is_on_the_admin_log_in_page_and_check_password_user_field_is_empty() {
...
//	}
//
//	@Then("Verify that admin user get the active element on the email userfield in admin forget password page")
//	public void verify_that_admin_user_get_the_active_element_on_the_email_userfield() {
