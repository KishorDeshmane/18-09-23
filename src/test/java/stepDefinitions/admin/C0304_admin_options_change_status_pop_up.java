...
public class C0304_admin_options_change_status_pop_up {
...
//	private Users_all_users_delete_pop_up_objects sadelete = new Users_all_users_delete_pop_up_objects(DriverFactory.getDriver());
	...
	Logger logger = LogManager.getLogger(C0304_admin_options_change_status_pop_up.class);
	...
	@Then("Verify that the pop up cross button should be clickable in admin change status all users action options pop up")
	...
	@Then("Verify that the pop up cross button click as expected pop up is not displayed in admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button should be clickable in the admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button side text should be displayed in the admin change status all users action options pop up")
	...
	@Then("Verify that the pop up switch button side text active or inactive is displayed in the admin change status all users action options pop up")
	...
	@Then("Verify that the pop up submit mouse hover is possible in the admin change status all users action options pop up")
	...
	@Then("Verify that the pop up cancel button mouse hover is possible in the admin change status all users action options pop up")
	...
	@Then("Verify that the pop up close button should be close the pop up in the admin change status all users action options pop up")
