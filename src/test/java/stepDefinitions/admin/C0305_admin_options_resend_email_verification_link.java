...
import com.pages.Users_all_users_resend_email_verification_link_objects;
...
public class C0305_admin_options_resend_email_verification_link {
	...
	private Users_all_users_resend_email_verification_link_objects saemailverif =new Users_all_users_resend_email_verification_link_objects(DriverFactory.getDriver());
	...
	Logger logger = LogManager.getLogger(C0305_admin_options_resend_email_verification_link.class);
...
//	
	...
	public void verify_that_admin_select_the_assigned_role_as_admin_in_the_create_user_page_admin(String string) {
	    sacreate.user_create_users_page_assigned_roles_drop_down_is_clic();
