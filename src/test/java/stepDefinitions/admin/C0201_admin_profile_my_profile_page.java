...
public class C0201_admin_profile_my_profile_page {
...
//	private Users_all_users_update_page_objects saedit = new Users_all_users_update_page_objects(DriverFactory.getDriver());
    ...
    @Then("Verify that page breadcrum my profile text is displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user last log in date should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user last log in time should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user ip address should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user agent should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user image in round circle is displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user name below image should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user role below image should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that tick mark below image should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that change passoword button should be displayed in the admin profie pop up my profile page")
    public void verify_that_change_passoword_button_should_be_displayed_in_the_admin_my_profile_page() {
    ...
    @Then("Verify that change password button should be clickable in the admin profie pop up my profile page")
    public void verify_that_change_password_button_should_be_clickable_in_the_admin_my_profile_page() {
    ...
    @Then("Verify that change password button should be able to mouse hover in the admin profie pop up my profile page")
    public void verify_that_change_password_button_should_be_able_to_mouse_hover_in_the_admin_my_profile_page() {
    ...
    @Then("Verify that personal information header should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that first name text above user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that first name user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that first name user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that last name text above user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that last name user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that last name user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that user name text above user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that user name user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that user name user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that email text above user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that email user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that email user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that email user field verify button should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that email user field verify button should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number text above the user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number country code user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number country code user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number user field placeholder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number verify button should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that mobile number verify button should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that profile image text above the user field should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that profile image user field should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that profile image user field place holder value should be {string} from the admin profie pop up my profile page")
    ...
    @Then("Verify that save button should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that save button should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that save button should be able to mouse hover from the admin profie pop up my profile page")
    ...
    @Then("Verify that cancel button should be displayed from the admin profie pop up my profile page")
    ...
    @Then("Verify that cancel button should be clickable from the admin profie pop up my profile page")
    ...
    @Then("Verify that cancel button should be able to mouse hover from the admin profie pop up my profile page")
	...
	@Then("Verify that first name asterisk sign should be displayed in the admin profie pop up my profile page")
	public void verify_that_first_name_asterisk_sign_should_be_displayed_in_the_admin_profile_page() {
	...
	@Then("Verify that last name asterisk sign should be displayed in the admin profie pop up my profile page")
	public void verify_that_last_name_asterisk_sign_should_be_displayed_in_the_admin_profile_page() {
	...
	@Then("Verify that email asterisk sign should be displayed in the admin profie pop up my profile page")
	...
	@Then("Verify that mobile number asterisk sign should be displayed in the admin profie pop up my profile page")
	public void verify_that_mobile_number_asterisk_sign_should_be_displayed_in_the_admin_my_profile_page() {
