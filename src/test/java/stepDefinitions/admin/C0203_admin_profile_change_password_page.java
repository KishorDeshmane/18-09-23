...
public class C0203_admin_profile_change_password_page {
	...
	Logger logger = LogManager.getLogger(C0203_admin_profile_change_password_page.class);
    ...
    @Then("Verify that page current password user field placeholder value should be {string} from the admin profile pop up change password page")
    ...
    @Then("Verify that page submit button should be displayed from the admin profile pop up change password page")
    ...
    @Then("Verify that page submit button should be clickable from the admin profile pop up change password page")
    ...
    @Then("Verify that page cancel button should be displayed from the admin profile pop up change password page")
    ...
    @Then("Verify that page cancel button should be clickable from the admin profile pop up change password page")
    ...
    @Then("Verify that page submit button should be able to mouse hover from admin profile pop up change password page")
    ...
    @Then("Verify that page cancel button should be able to mouse hover from admin profile pop up change password page")
    ...
    @Then("Verify that page comfirm password title text is displayed in the admin profile pop up change password second page")
    ...
    @Then("Verify that page new password userfield placeholder value should be {string} in the admin profile pop up change password second page")
    ...
    @Then("Verify that page comfirm password userfield placeholder value should be {string} in the admin profile pop up change password second page")
    ...
    @Then("Verify that page comfirm password userfield should be clickable in the admin profile pop up change password second page")
    ...
    @Then("Verify that page submit button should be displayed from the admin profile pop up change password second page")
    ...
    @Then("Verify that page submit button should be clickable from the admin profile pop up change password second page")
    ...
    @Then("Verify that page cancel button should be displayed from the admin profile pop up change password second page")
    ...
    @Then("Verify that page cancel button should be clickable from the admin profile pop up change password second page")
    ...
    @Then("Verify that page submit button should be able to mouse hover from admin profile pop up change password second page")
    ...
    @Then("Verify that page cancel button should be able to mouse hover from admin profile pop up change password second page")
