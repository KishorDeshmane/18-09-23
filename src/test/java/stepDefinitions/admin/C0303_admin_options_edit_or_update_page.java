...
public class C0303_admin_options_edit_or_update_page {
	...
	private Users_all_users_update_page_objects saedit= new Users_all_users_update_page_objects(DriverFactory.getDriver());
//	private Users_all_users_create_users_page_objects sacreate = new Users_all_users_create_users_page_objects(DriverFactory.getDriver());
	...
	Logger logger = LogManager.getLogger(C0303_admin_options_edit_or_update_page.class);
	...
	public void verify_that_the_user_is_on_the_update_user_page_in_the_admin_dashboard_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_page_header_is_displayed();
	...
	public void verify_that_the_breadcrum_is_displayed_in_the_admin_dashboard_all_users_action_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_breadcrum_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_breadcrum_all_users_is_displayed_in_the_admin_dashboard_all_users_action_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_breadcrum_all_user_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_breadcrum_all_users_is_clickable_in_the_admin_dashboard_all_users_action_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_breadcrum_all_user_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_breadcrum_update_user_text_is_displayed_in_the_admin_dashbaord_all_users_action_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_breadcrum_update_user_text_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_card_body_personnel_information_header_should_be_displayed_in_the_admin_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_card_body_personnel_information_header_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_first_name_text_above_users_field_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_first_name_text_above_users_field_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_first_name_users_field_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_first_name_users_field_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that first name users field placeholder value should be  {string} in the admin all users actions update page")
	public void verify_that_first_name_users_field_placeholder_value_should_be_in_the_admin_dashboard_users_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_first_name_users_field_placeholder_value();
	...
	public void verify_that_last_name_text_above_users_field_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_last_name_text_above_users_field_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_last_name_users_field_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_last_name_users_field_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that last name users field placeholder value should be  {string} in the admin all users actions update page")
	public void verify_that_last_name_users_field_placeholder_value_should_be_in_the_admin_dashboard_users_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_last_name_users_field_placeholder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_email_text_above_users_field_should_be_displayed_in_the_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_email_text_above_users_field_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_email_users_field_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_email_users_field_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that email users field placeholder value should be  {string} in the admin all users actions update page")
	public void verify_that_email_users_field_placeholder_value_should_be_in_the_admin_dashboard_users_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_email_users_field_placeholder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_text_above_the_users_field_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_mobile_number_text_above_users_field_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_country_code_dropdown_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_mobile_number_country_code_dropdown_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_country_code_dropdown_list_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_mobile_number_country_code_dropdown_list_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_mobile_number_users_field_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_mobile_number_users_field_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that mobile number users field place holder value should be {string} in the admin all users actions update page")
	public void verify_that_mobile_number_users_field_place_holder_value_should_be_in_the_admin_dashboard_users_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_mobile_number_users_field_placeholder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that the date of birth button should be clickable in the admin all users actions update page")
	public void verify_that_the_date_of_birth_button_should_be_clickable_in_the_admin_users_all_users_actions_edit_button() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_date_of_birth_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that date of birth userfield should be displayed in the admin all users actions update page")
	public void verify_that_date_of_birth_userfield_should_be_displayed_in_the_admin_users_all_users_actions_edit_button() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_date_of_birth_userfield_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that date of birth userfield should be clickable in the admin all users actions update page")
	public void verify_that_date_of_birth_userfield_should_be_clickable_in_the_admin_users_all_users_actions_edit_button() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_date_of_birth_userfield_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that date of birth placeholder value should be {string} in the admin all users actions update page")
	public void verify_that_date_of_birth_placeholder_value_should_be_in_the_admin_users_all_users_action_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_date_of_birth_userfeld_placeholder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_profile_image_title_text_above_the_userfield_should_be_displayed_in_the_admin_dashboard_all_users_actions_edit_button() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_profile_image_title_text_above_the_userfield_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_profile_image_userfield_button_should_be_displayed_in_the_admin_dashboard_all_users_actions_edit_buttin() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_profile_image_userfield_button_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_the_profile_image_userfield_button_should_not_be_clickable_in_the_admin_dashboard_all_users_actions_edit_button() {
		boolean actual = saedit.super_admin_logger_all_users_actions_option_update_user_profile_image_userfield_button_is_clickable();
		Assert.assertEquals(actual, false);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that the profile image userfield button placeholder value should be {string} in admin all users actions update page")
	public void verify_that_the_profile_image_userfield_button_placeholder_value_should_be_in_admin_dashboard_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_profile_image_userfield_button_placeholder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_card_body_role_information_header_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_card_body_role_information_header_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_assigned_roles_text_above_user_field_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_text_above_user_field_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_assigned_roles_user_field_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_user_field_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_assigned_roles_drop_down_should_be_clickable_in_the_admin_dashboard_users_all_user_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_drop_down_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that assigned roles dropdown place holder value should be {string} in the admin all users actions update page")
	public void verify_that_assigned_roles_dropdown_place_holder_value_should_be_in_the_admin_dashboard_users_all_users_actions_edit_button(String string) {
		String actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_dropdown_place_holder_value();
		Assert.assertEquals(actual, string);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_assigned_roles_drop_down_admin_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_drop_down_admin_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that assigned roles drop down super admin should be clickable in the admin all users actions update page")
	public void verify_that_assigned_roles_drop_down_super_admin_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual = saedit.administraor_logger_all_users_actions_option_update_user_assigned_roles_drop_down_super_admin_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_submit_button_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_submit_button_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_submit_button_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_submit_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_cancel_button_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_cancel_button_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_cancel_button_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_cancel_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_back_to_top_arrow_button_should_be_displayed_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_back_to_top_arrow_button_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_back_to_top_arrow_button_should_be_clickable_in_the_admin_dashboard_users_all_users_actions_edit_button() {
		boolean actual=saedit.super_admin_logger_update_users_page_back_to_top_arrow_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
