...
public class B0601_super_admin_service_category_management_page {
	...
	@Given("Verify that super admin user is on lookups service category management page as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_lookups_service_category_management_page_as_expected_page_title_is(String string) {
