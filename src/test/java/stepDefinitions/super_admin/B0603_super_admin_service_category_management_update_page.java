...
import com.pages.Lookups_service_category_management_update_page_objects;
...
public class B0603_super_admin_service_category_management_update_page {
	...
	private Lookups_service_category_management_update_page_objects sascme = new Lookups_service_category_management_update_page_objects(DriverFactory.getDriver());
	Logger logger = LogManager.getLogger(B0603_super_admin_service_category_management_update_page.class);
	...
	@Given("Verify that super admin user is on lookups service category management edit page as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_lookups_service_category_management_edit_page_as_expected_page_title_is(String string) {
