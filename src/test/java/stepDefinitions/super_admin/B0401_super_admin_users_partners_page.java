...
public class B0401_super_admin_users_partners_page {
	...
	@Then("Verify that search user field place holder value should be {string} in the super admin partners users page")
	...
	@Then("Verify that actions options {int} dots should be able to mouse hover from the super admin partners users page")
