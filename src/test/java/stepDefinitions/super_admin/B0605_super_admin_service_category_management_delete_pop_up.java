...
import com.pages.Lookups_service_category_management_delete_pop_up_objects;
...
public class B0605_super_admin_service_category_management_delete_pop_up {
	...
	private Lookups_service_category_management_delete_pop_up_objects sascmd = new Lookups_service_category_management_delete_pop_up_objects(DriverFactory.getDriver());
	...
	@Given("Verify that super admin user is on lookups service category management delete pop up as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_lookups_service_category_management_delete_pop_up_as_expected_page_title_is(String string) {
