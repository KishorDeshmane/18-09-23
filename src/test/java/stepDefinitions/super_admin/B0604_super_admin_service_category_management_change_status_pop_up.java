...
import com.pages.Lookups_service_category_management_change_status_pop_up_objects;
...
public class B0604_super_admin_service_category_management_change_status_pop_up {
	...
	private Lookups_service_category_management_change_status_pop_up_objects sascmc = new Lookups_service_category_management_change_status_pop_up_objects(DriverFactory.getDriver());
	...
	@Given("Verify that super admin user is on lookups service category management change status pop up as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_lookups_service_category_management_change_status_pop_up_as_expected_page_title_is(String string) {
