...
public class B0602_super_admin_create_service_category_page {
	...
	@Given("Verify that super admin user is on lookups create service category page as expected page title is {string}")
	public void verify_that_super_admin_user_is_on_lookups_create_service_category_page_as_expected_page_title_is(String string) {
