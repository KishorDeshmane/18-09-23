...
import com.pages.Users_all_users_create_users_page_objects;
import com.pages.Users_all_users_delete_pop_up_objects;
...
public class B0308_super_admin_options_delete_pop_up {
	...
	public void super_admin_click_on_the_delete_button_from_the_super_admin_dashboard_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_bigger_i_text_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}

	@Then("Verify that delete comfirmation pop displayed having are you sure text from super admin all users action options delete pop up")
	public void verify_that_super_admin_comfirmation_pop_displayed_having_are_you_sure_text_from_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_are_you_sure_text_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that delete comfirmation pop up you want to delete this user text is displayed in the super admin all users action options delete pop up")
	public void verify_that_super_admin_comfirmation_pop_up_you_want_to_delete_this_user_text_is_displayed_in_the_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_you_want_to_delete_this_user_text_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that delete comfirmation pop up yes delete it button is clickable in the super admin all users action options delete pop up")
	public void verify_that_super_admin_comfirmation_pop_up_yes_delete_it_button_is_clickable_in_the_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_yes_delete_it_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that delete comfirmation pop up yes delete it button is displayed in the super admin all users action options delete pop up")
	...
	@Then("Verify that delete comfirmation pop up cancel button is displayed in the super admin all users action options delete pop up")
	public void verify_that_delete_comfirmation_pop_up_cancel_button_is_displayed_in_the_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_cancel_button_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that delete comfirmation pop up cancel button is clickable in the super admin all users action options delete pop up")
	public void verify_that_delete_comfirmation_pop_up_cancel_button_is_clickable_in_the_all_users_actions_options_button() {
		boolean actual = sadelete.users_all_users_actions_option_cancel_button_is_clickable();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	
	@Then("Verify that delete comfirmation pop up name of the user is displayed in super admin all users action options delete pop up")
	public void verify_that_delete_comfirmation_pop_up_name_of_the_user_is_displayed_in_the_all_users_actions_button() {
		boolean actual = sadelete.users_all_users_actions_option_name_of_the_user_is_displayed();
		Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
	...
	public void verify_that_super_admin_cancel_button_should_cancel_the_pop_an_user_is_on_all_user_page_from_optiion_button() {
		sadelete.users_all_users_actions_option_cancel_button_is_click();
...
//	}
	...
	public void verify_that_super_admin_should_be_able_to_delete_the_user_from_the_all_users_page() {
	    saalluser.users_all_users_actions_options_3_dots_is_click();
	    saalluser.users_all_users_actions_option_delete_is_click();
	    sadelete.users_all_users_actions_option_yes_delete_it_pop_up_is_click();
	    boolean actual = sadelete.users_all_users_actions_option_delete_successfully_is_displayed();
	    Assert.assertEquals(actual, true);
		logger.info(Thread.currentThread().getStackTrace()[1].getMethodName());
		AppHooks.scn.log(Thread.currentThread().getStackTrace()[1].getMethodName());
	}
