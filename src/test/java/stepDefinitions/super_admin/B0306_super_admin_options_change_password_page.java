...
public class B0306_super_admin_options_change_password_page {
	...
	private Users_all_users_change_status_pop_up_objects cha = new Users_all_users_change_status_pop_up_objects(DriverFactory.getDriver());
...
//	    inactive admin user temporary
	    ...
	    cha.user_all_user_actions_options_change_status_button_pop_up_switch_button_is_click();
	    cha.user_all_user_actions_options_change_status_button_pop_up_submit_button_is_click();
	    saalluser.users_all_users_actions_options_3_dots_is_click();
